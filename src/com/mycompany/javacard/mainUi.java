...
//    SmartCaedWord connect ;
//    ChangePass changePass;
//    thaydoiinf changeInf;
//    naptinen napTien;
//    thanhtoan thanhtoan;
...
//        jLabel11.setText(SmartCaedWord.getInstance().getMoney());
        if(SmartCardWord.getInstance().getMoney().equals("")){
            jLabel11.setText("0đ");
        }else{
            jLabel11.setText( String.format("%,.2f",Double.parseDouble(SmartCardWord.getInstance().getMoney())) +" vnđ");
       
        }
        System.out.println("money" + SmartCardWord.getInstance().getMoney());
    }
  
    
 public void getms(){
     System.out.println("info : " + SmartCardWord.getInstance().getInforKT()); 
   jLabel2.setText(SmartCardWord.getInstance().getInforKT()+"");
 }
 public void getInfo(){
     ...
     jLabel6.setText(parts[3]);
     jLabel8.setText(parts[2]);
     jLabel10.setText(parts[1]);
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thông tin", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        jLabel12.setText("Số dư hiện tại");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      ChangeInfo changeInf = new ChangeInfo();
        changeInf.setVisible(true);
        this.setVisible(false);
        changeInf.setLocationRelativeTo(null);        // TODO add your handling code here:
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        History lichsugiaodich = new History();
        lichsugiaodich.setVisible(true);
        this.setVisible(false);
        lichsugiaodich.setLocationRelativeTo(null); 
